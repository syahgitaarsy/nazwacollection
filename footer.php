		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/remove.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Toko online penyedia gamis wanita, remaja dan anak tersedia berbagai ukuran dengan kualitas terbaik.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<p> Untuk konfirmasi pesanan atau menanyakan produk klik logo dibawah ini </p>

				<div class="footer-logo">
					<a class="logo" href="https://api.whatsapp.com/send?phone=6282249585017&text=Halo%20Admin!%0ASaya%20ingin%20konfirmasi%20pesanan%20saya">
					<img src="frontend/img/compress.png" alt="">
					</a>
				</div>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						<li><a href="https://www.facebook.com/noviroh.noviroh.1/"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://www.instagram.com/nazw.acollection/"><i class="fa fa-instagram"></i></a></li>
					</ul>
					<!-- /footer social -->
				</div>
			</div>
